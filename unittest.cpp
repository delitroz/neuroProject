...
int main(int argc, char **argv)
{
	...
	/*!
	 * @brief test if the membrane pototial compute well during an update
	 */
	...
	/*!
	 * @brief test if the membrane potential behave correctly after numerous
	 * 		  update
	 * 
	 * with an external current value of 1 the membranne potential
	 * should tend to the treshold potential(=20) withoud reaching it
	 * 
	 * test fail everytime even if the value are exactly the same in the
	 * terminal. I do not know why.
	 */
	...
	/*!
	 * @brief test if the membrane potential decrease as predicted to 0 in
	...
	/*!
	 * @brief test the actual total number of neuron and the number of 
	...
	/*!
	 * @brief test the actual total number of connection and the number of
